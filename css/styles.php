...
//Dynamic styles
    ...
    $the_monday_body_text_color = get_theme_mod( 'body_font_color', '#000000' );
        
        $custom_css .="#content h2{ font:700 24px ".esc_attr( $the_monday_header_font_family )." }"."\n";
        ...
        $custom_css .="#content{font:400 16px ".esc_attr( $the_monday_body_font_family )."}"."\n";

    /*Dynamic Color*/
    $the_monday_primary_color = get_theme_mod( 'primary_color', '#2e8ecb' );
    $the_monday_secondary_color = '';
        ...
        $custom_css .= ".site-header .head-wrap .home-nav ul > li a:hover, .site-header .head-wrap .home-nav ul > li a.active{ border-top: 1px solid". esc_attr( $the_monday_primary_color ) ."}"."\n";
        ...
        $custom_css .= "#content .about-content a:hover{ border-color:". esc_attr( $the_monday_primary_color ) ."}"."\n";        
